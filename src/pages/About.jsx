export default function About({ lang }) {
    const content = {
      ...
      es: {
        ...
        paragraphs: [
          "Somos una iglesia Bautista Independiente de la vieja escuela. Sostenemos la autoridad de las Escrituras y usamos exclusivamente la Biblia Reina-Valera 1960 para predicar y enseñar.",
    ...
    return (
      <div style={{ maxWidth: "700px", margin: "2rem auto", padding: "2rem", backgroundColor: "#FFFFFF", borderRadius: "8px" }}>
        <h1 style={{ textAlign: "center" }}>{content[lang].title}</h1>
        {content[lang].paragraphs.map((text, i) => (
          <p key={i} style={{ lineHeight: "1.6", marginTop: "1rem" }}>{text}</p>
        ))}
      </div>
    );
  }
